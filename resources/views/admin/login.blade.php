...
<head>
    ...
    <title>Admin Panelge Kiriw!</title>
            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" action="{{ route('admin.check') }}" class="register-form" id="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('email') }}" type="text" name="email" id="your_name"
                                    placeholder="Emailin`izdi kiritin`..." />
                        ...
                        <div class="social-login">
                            <div class="btn-group">
                                <a href="{{ route('user.login') }}" class="btn btn-primary active" aria-current="page">Paydalaniwshi</a>
